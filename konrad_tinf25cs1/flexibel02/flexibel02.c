...
{
	/* Lokale Variablen */
	/* Variablen vom Typ 'flexibler_struct_typ'. */
	struct flexibler_struct_typ	flexibel1, flexibel2;
...
if(0)
{
	...
	/* 1. Element initialisieren. */
	flexibel1.aktuellerTyp= double_typ;
	flexibel1.daten.d= 5.7;
	flexibel1.next_ptr= &flexibel2;
	flexibel1.back_ptr= NULL;
	
	/* 2. Element initialisieren. */
	flexibel2.aktuellerTyp= text_typ;
	strcpy(flexibel2.daten.text, "Jetzt ist hier ein Text.");
	flexibel2.next_ptr= NULL;
	flexibel2.back_ptr= &flexibel1;

	printf("Liste vorwaerts durchlaufen:\n");
	n = durchlaufen(&flexibel1, vorwaerts, ausgabe_lang, ausgabe_fptr);
	printf("main(): Anzahl Listenelemente = n = %d\n", n);

	printf("Liste rueckwaerts durchlaufen:\n");
	n = durchlaufen(&flexibel2, rueckwaerts, ausgabe_lang, ausgabe_fptr);
	printf("main(): Anzahl Listenelemente = n = %d\n", n);

	printf("Liste im Blindflug durchlaufen:\n");
	n = durchlaufen(&flexibel2, rueckwaerts, NULL, ausgabe_fptr);
	printf("main(): Anzahl Listenelemente = n = %d\n", n);

	printf("Liste rueckwaerts mit kuerzer Ausgabe durchlaufen:\n");
	n = durchlaufen(&flexibel2, rueckwaerts, ausgabe_kurz, ausgabe_fptr);
	printf("main(): Anzahl Listenelemente = n = %d\n", n);
